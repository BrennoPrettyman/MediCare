...
<body>
    <div class="box2">
        <a id="back" href="#"><img src="css/media/setablue.png" id="volta"></a>
        <div class="content">
            <h1>MediCare</h1>
            <span>Iniciar Atendimento</span>
        </div>
        <a href=""><img src="css/media/space.png" id="space"></a>
    </div>
    ...
    <div class="Bloco">
        <form method="post" action="qrcodeex.php" class="container form">
            ...
            <p>Esqueceu sua senha? <a href="recuperar.html">Recupere!</a></p>
        </form>
    </div>
</body>
